...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(71851090238750585)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71851414765750586)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71851670183750586)
,p_page_template_id=>wwv_flow_imp.id(71851090238750585)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71851960030750586)
,p_page_template_id=>wwv_flow_imp.id(71851090238750585)
