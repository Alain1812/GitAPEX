...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(25686645830209915)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25686912140209917)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25687252604209917)
,p_page_template_id=>wwv_flow_imp.id(25686645830209915)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25687573397209918)
,p_page_template_id=>wwv_flow_imp.id(25686645830209915)
