...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(71844203191750580)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71844469501750582)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71844809965750582)
,p_page_template_id=>wwv_flow_imp.id(71844203191750580)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71845130758750583)
,p_page_template_id=>wwv_flow_imp.id(71844203191750580)
