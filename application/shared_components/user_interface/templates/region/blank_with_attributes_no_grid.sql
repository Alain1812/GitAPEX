...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71881539866750595)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71881776564750595)
,p_plug_template_id=>wwv_flow_imp.id(71881539866750595)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71882116398750596)
,p_plug_template_id=>wwv_flow_imp.id(71881539866750595)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71882409081750596)
,p_plug_template_id=>wwv_flow_imp.id(71881539866750595)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71882749846750596)
,p_plug_template_id=>wwv_flow_imp.id(71881539866750595)
,p_name=>'Sub Regions'
