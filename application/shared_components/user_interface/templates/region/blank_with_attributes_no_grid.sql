...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25723982505209930)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25724219203209930)
,p_plug_template_id=>wwv_flow_imp.id(25723982505209930)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25724559037209931)
,p_plug_template_id=>wwv_flow_imp.id(25723982505209930)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25724851720209931)
,p_plug_template_id=>wwv_flow_imp.id(25723982505209930)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25725192485209931)
,p_plug_template_id=>wwv_flow_imp.id(25723982505209930)
,p_name=>'Sub Regions'
