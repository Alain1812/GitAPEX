...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25722577274209930)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25722825190209930)
,p_plug_template_id=>wwv_flow_imp.id(25722577274209930)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25723134415209930)
,p_plug_template_id=>wwv_flow_imp.id(25722577274209930)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25723461843209930)
,p_plug_template_id=>wwv_flow_imp.id(25722577274209930)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25723709563209930)
,p_plug_template_id=>wwv_flow_imp.id(25722577274209930)
,p_name=>'Sub Regions'
