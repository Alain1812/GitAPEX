...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71880134635750595)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71880382551750595)
,p_plug_template_id=>wwv_flow_imp.id(71880134635750595)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71880691776750595)
,p_plug_template_id=>wwv_flow_imp.id(71880134635750595)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71881019204750595)
,p_plug_template_id=>wwv_flow_imp.id(71880134635750595)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71881266924750595)
,p_plug_template_id=>wwv_flow_imp.id(71880134635750595)
,p_name=>'Sub Regions'
