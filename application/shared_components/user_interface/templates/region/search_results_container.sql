...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71943970524750612)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71944346210750612)
,p_plug_template_id=>wwv_flow_imp.id(71943970524750612)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71944632461750612)
,p_plug_template_id=>wwv_flow_imp.id(71943970524750612)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71944871230750612)
,p_plug_template_id=>wwv_flow_imp.id(71943970524750612)
,p_name=>'Sub Regions'
