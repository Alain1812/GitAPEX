...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25786413163209947)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25786788849209947)
,p_plug_template_id=>wwv_flow_imp.id(25786413163209947)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25787075100209947)
,p_plug_template_id=>wwv_flow_imp.id(25786413163209947)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25787313869209947)
,p_plug_template_id=>wwv_flow_imp.id(25786413163209947)
,p_name=>'Sub Regions'
