...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71874858892750592)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71875257005750593)
,p_plug_template_id=>wwv_flow_imp.id(71874858892750592)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71875487373750594)
,p_plug_template_id=>wwv_flow_imp.id(71874858892750592)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71875820949750594)
,p_plug_template_id=>wwv_flow_imp.id(71874858892750592)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71876124629750594)
,p_plug_template_id=>wwv_flow_imp.id(71874858892750592)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71876365465750594)
,p_plug_template_id=>wwv_flow_imp.id(71874858892750592)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71876735419750594)
,p_plug_template_id=>wwv_flow_imp.id(71874858892750592)
,p_name=>'Sub Regions'
