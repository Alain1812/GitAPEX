...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71908822762750603)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71909063442750603)
,p_plug_template_id=>wwv_flow_imp.id(71908822762750603)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71909400608750603)
,p_plug_template_id=>wwv_flow_imp.id(71908822762750603)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71909685006750603)
,p_plug_template_id=>wwv_flow_imp.id(71908822762750603)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71910032992750603)
,p_plug_template_id=>wwv_flow_imp.id(71908822762750603)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71910280854750603)
,p_plug_template_id=>wwv_flow_imp.id(71908822762750603)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71910571539750603)
,p_plug_template_id=>wwv_flow_imp.id(71908822762750603)
,p_name=>'Sub Regions'
