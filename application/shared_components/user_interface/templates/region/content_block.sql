...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25751265401209938)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25751506081209938)
,p_plug_template_id=>wwv_flow_imp.id(25751265401209938)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25751843247209938)
,p_plug_template_id=>wwv_flow_imp.id(25751265401209938)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25752127645209938)
,p_plug_template_id=>wwv_flow_imp.id(25751265401209938)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25752475631209938)
,p_plug_template_id=>wwv_flow_imp.id(25751265401209938)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25752723493209938)
,p_plug_template_id=>wwv_flow_imp.id(25751265401209938)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25753014178209938)
,p_plug_template_id=>wwv_flow_imp.id(25751265401209938)
,p_name=>'Sub Regions'
