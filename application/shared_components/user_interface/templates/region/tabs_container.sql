...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71956466997750615)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71956790139750615)
,p_plug_template_id=>wwv_flow_imp.id(71956466997750615)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71957068809750616)
,p_plug_template_id=>wwv_flow_imp.id(71956466997750615)
,p_name=>'Tabs'
