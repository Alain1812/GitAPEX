...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25798909636209950)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25799232778209950)
,p_plug_template_id=>wwv_flow_imp.id(25798909636209950)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25799511448209951)
,p_plug_template_id=>wwv_flow_imp.id(25798909636209950)
,p_name=>'Tabs'
