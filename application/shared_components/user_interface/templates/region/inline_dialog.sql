...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25764753675209941)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25765050595209941)
,p_plug_template_id=>wwv_flow_imp.id(25764753675209941)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25765330161209942)
,p_plug_template_id=>wwv_flow_imp.id(25764753675209941)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25765671297209942)
,p_plug_template_id=>wwv_flow_imp.id(25764753675209941)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25765959653209942)
,p_plug_template_id=>wwv_flow_imp.id(25764753675209941)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25766262101209942)
,p_plug_template_id=>wwv_flow_imp.id(25764753675209941)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25766569291209942)
,p_plug_template_id=>wwv_flow_imp.id(25764753675209941)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25766828949209942)
,p_plug_template_id=>wwv_flow_imp.id(25764753675209941)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25767117131209942)
,p_plug_template_id=>wwv_flow_imp.id(25764753675209941)
,p_name=>'Sub Regions'
