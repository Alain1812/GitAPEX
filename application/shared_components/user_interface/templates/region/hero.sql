...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25755885172209939)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25756145524209939)
,p_plug_template_id=>wwv_flow_imp.id(25755885172209939)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25756478161209939)
,p_plug_template_id=>wwv_flow_imp.id(25755885172209939)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25756796345209939)
,p_plug_template_id=>wwv_flow_imp.id(25755885172209939)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25757086837209939)
,p_plug_template_id=>wwv_flow_imp.id(25755885172209939)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25757304498209939)
,p_plug_template_id=>wwv_flow_imp.id(25755885172209939)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
