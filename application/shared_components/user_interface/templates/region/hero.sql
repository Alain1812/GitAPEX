...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71913442533750604)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71913702885750604)
,p_plug_template_id=>wwv_flow_imp.id(71913442533750604)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71914035522750604)
,p_plug_template_id=>wwv_flow_imp.id(71913442533750604)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71914353706750604)
,p_plug_template_id=>wwv_flow_imp.id(71913442533750604)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71914644198750604)
,p_plug_template_id=>wwv_flow_imp.id(71913442533750604)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71914861859750604)
,p_plug_template_id=>wwv_flow_imp.id(71913442533750604)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
