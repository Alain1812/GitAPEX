...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25779375828209945)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25779646702209945)
,p_plug_template_id=>wwv_flow_imp.id(25779375828209945)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25779978577209945)
,p_plug_template_id=>wwv_flow_imp.id(25779375828209945)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25780286033209945)
,p_plug_template_id=>wwv_flow_imp.id(25779375828209945)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25780559850209945)
,p_plug_template_id=>wwv_flow_imp.id(25779375828209945)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25780851793209945)
,p_plug_template_id=>wwv_flow_imp.id(25779375828209945)
,p_name=>'Sub Regions'
