...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71936933189750610)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71937204063750610)
,p_plug_template_id=>wwv_flow_imp.id(71936933189750610)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71937535938750610)
,p_plug_template_id=>wwv_flow_imp.id(71936933189750610)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71937843394750610)
,p_plug_template_id=>wwv_flow_imp.id(71936933189750610)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71938117211750610)
,p_plug_template_id=>wwv_flow_imp.id(71936933189750610)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71938409154750610)
,p_plug_template_id=>wwv_flow_imp.id(71936933189750610)
,p_name=>'Sub Regions'
