...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71941514798750611)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71941813588750611)
,p_plug_template_id=>wwv_flow_imp.id(71941514798750611)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71942126012750611)
,p_plug_template_id=>wwv_flow_imp.id(71941514798750611)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71942451693750612)
,p_plug_template_id=>wwv_flow_imp.id(71941514798750611)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71942671365750612)
,p_plug_template_id=>wwv_flow_imp.id(71941514798750611)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71942980158750612)
,p_plug_template_id=>wwv_flow_imp.id(71941514798750611)
,p_name=>'Sub Regions'
