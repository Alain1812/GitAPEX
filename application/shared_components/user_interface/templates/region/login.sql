...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25783957437209946)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25784256227209946)
,p_plug_template_id=>wwv_flow_imp.id(25783957437209946)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25784568651209946)
,p_plug_template_id=>wwv_flow_imp.id(25783957437209946)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25784894332209947)
,p_plug_template_id=>wwv_flow_imp.id(25783957437209946)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25785114004209947)
,p_plug_template_id=>wwv_flow_imp.id(25783957437209946)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25785422797209947)
,p_plug_template_id=>wwv_flow_imp.id(25783957437209946)
,p_name=>'Sub Regions'
