...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25781494775209946)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25781749477209946)
,p_plug_template_id=>wwv_flow_imp.id(25781494775209946)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25782007635209946)
,p_plug_template_id=>wwv_flow_imp.id(25781494775209946)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25782380534209946)
,p_plug_template_id=>wwv_flow_imp.id(25781494775209946)
,p_name=>'Button Start'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(35193212861555983)
,p_plug_template_id=>wwv_flow_imp.id(25781494775209946)
,p_name=>'Sub Regions'
