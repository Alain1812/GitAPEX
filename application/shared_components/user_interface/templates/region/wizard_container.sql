...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71964161439750617)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71964480929750618)
,p_plug_template_id=>wwv_flow_imp.id(71964161439750617)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71964770493750618)
,p_plug_template_id=>wwv_flow_imp.id(71964161439750617)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71965107141750618)
,p_plug_template_id=>wwv_flow_imp.id(71964161439750617)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71965433425750618)
,p_plug_template_id=>wwv_flow_imp.id(71964161439750617)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71965683100750618)
,p_plug_template_id=>wwv_flow_imp.id(71964161439750617)
