...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25806604078209952)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25806923568209953)
,p_plug_template_id=>wwv_flow_imp.id(25806604078209952)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25807213132209953)
,p_plug_template_id=>wwv_flow_imp.id(25806604078209952)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25807549780209953)
,p_plug_template_id=>wwv_flow_imp.id(25806604078209952)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25807876064209953)
,p_plug_template_id=>wwv_flow_imp.id(25806604078209952)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25808125739209953)
,p_plug_template_id=>wwv_flow_imp.id(25806604078209952)
