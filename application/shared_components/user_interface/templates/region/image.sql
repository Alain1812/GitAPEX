...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25759355942209940)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25759677143209940)
,p_plug_template_id=>wwv_flow_imp.id(25759355942209940)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25759976648209940)
,p_plug_template_id=>wwv_flow_imp.id(25759355942209940)
,p_name=>'Sub Regions'
