...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71916913303750605)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71917234504750605)
,p_plug_template_id=>wwv_flow_imp.id(71916913303750605)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71917534009750605)
,p_plug_template_id=>wwv_flow_imp.id(71916913303750605)
,p_name=>'Sub Regions'
