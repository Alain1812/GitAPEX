...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71887176006750597)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71887551153750597)
,p_plug_template_id=>wwv_flow_imp.id(71887176006750597)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71887833488750597)
,p_plug_template_id=>wwv_flow_imp.id(71887176006750597)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(71888064525750597)
,p_plug_template_id=>wwv_flow_imp.id(71887176006750597)
,p_name=>'Sub Regions'
