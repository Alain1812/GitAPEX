...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(25729618645209932)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25729993792209932)
,p_plug_template_id=>wwv_flow_imp.id(25729618645209932)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25730276127209932)
,p_plug_template_id=>wwv_flow_imp.id(25729618645209932)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(25730507164209932)
,p_plug_template_id=>wwv_flow_imp.id(25729618645209932)
,p_name=>'Sub Regions'
