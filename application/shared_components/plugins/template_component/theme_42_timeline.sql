...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(25935921024210063)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2173018866419317016)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2173019421431317017)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25936677000210066)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25936941299210066)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25937275725210066)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25937502493210066)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25937810139210067)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25938152836210067)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25938402834210067)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(25937810139210067)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2173019421431317017)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25938798629210067)
,p_plugin_attribute_id=>wwv_flow_imp.id(25938402834210067)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25939177670210067)
,p_plugin_attribute_id=>wwv_flow_imp.id(25938402834210067)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25939508090210068)
,p_plugin_attribute_id=>wwv_flow_imp.id(25938402834210067)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25940018590210068)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(25938402834210067)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25940313525210069)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25940630556210069)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25940956047210069)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25941207522210069)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25941532166210070)
,p_plugin_attribute_id=>wwv_flow_imp.id(25941207522210069)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25941972911210070)
,p_plugin_attribute_id=>wwv_flow_imp.id(25941207522210069)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25942300115210071)
,p_plugin_attribute_id=>wwv_flow_imp.id(25941207522210069)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25942723964210071)
,p_plugin_attribute_id=>wwv_flow_imp.id(25941207522210069)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25943118837210071)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(25938152836210067)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2173018866419317016)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25943434143210072)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25943732354210072)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25944092206210072)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25944322124210072)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25944623768210073)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25944943381210073)
,p_plugin_attribute_id=>wwv_flow_imp.id(25944623768210073)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25945306656210073)
,p_plugin_attribute_id=>wwv_flow_imp.id(25944623768210073)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25945736876210073)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25946032220210073)
,p_plugin_attribute_id=>wwv_flow_imp.id(25945736876210073)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25946441573210074)
,p_plugin_attribute_id=>wwv_flow_imp.id(25945736876210073)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25946830313210074)
,p_plugin_attribute_id=>wwv_flow_imp.id(25945736876210073)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25947271387210074)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25947583246210074)
,p_plugin_attribute_id=>wwv_flow_imp.id(25947271387210074)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-Timeline--compact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25947906726210075)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1820788766617525603)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1935200129605789204)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2054231376580093645)
,p_plugin_id=>wwv_flow_imp.id(25935921024210063)
,p_name=>'Avatar Link'
