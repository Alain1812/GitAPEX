...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(25892578332210018)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1953130331070281716)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1953129776058281715)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1696237712328008202)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25893447826210022)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25893750717210022)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25894054354210023)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25894372488210023)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25894698172210023)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25894948522210023)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25895272775210023)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(25894698172210023)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1953130331070281716)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25895543592210024)
,p_plugin_attribute_id=>wwv_flow_imp.id(25895272775210023)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25895978605210024)
,p_plugin_attribute_id=>wwv_flow_imp.id(25895272775210023)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25896365029210024)
,p_plugin_attribute_id=>wwv_flow_imp.id(25895272775210023)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25896782419210025)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(25895272775210023)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25897015170210025)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25897339906210025)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25897686174210025)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25897910054210025)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25898296248210026)
,p_plugin_attribute_id=>wwv_flow_imp.id(25897910054210025)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25898670965210026)
,p_plugin_attribute_id=>wwv_flow_imp.id(25897910054210025)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25899047810210026)
,p_plugin_attribute_id=>wwv_flow_imp.id(25897910054210025)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25899413088210027)
,p_plugin_attribute_id=>wwv_flow_imp.id(25897910054210025)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25899888629210027)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(25894948522210023)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1953129776058281715)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25900132550210027)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25900443963210027)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25900782040210028)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25901079231210028)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25901361855210028)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25901610884210028)
,p_plugin_attribute_id=>wwv_flow_imp.id(25901361855210028)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25902096167210029)
,p_plugin_attribute_id=>wwv_flow_imp.id(25901361855210028)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25902464991210029)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25902777636210029)
,p_plugin_attribute_id=>wwv_flow_imp.id(25902464991210029)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25903110142210029)
,p_plugin_attribute_id=>wwv_flow_imp.id(25902464991210029)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25903593179210030)
,p_plugin_attribute_id=>wwv_flow_imp.id(25902464991210029)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25903908484210030)
,p_plugin_attribute_id=>wwv_flow_imp.id(25902464991210029)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25904304311210030)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25904608782210030)
,p_plugin_attribute_id=>wwv_flow_imp.id(25904304311210030)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25905056766210030)
,p_plugin_attribute_id=>wwv_flow_imp.id(25904304311210030)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25905425720210031)
,p_plugin_attribute_id=>wwv_flow_imp.id(25904304311210030)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25905820862210031)
,p_plugin_attribute_id=>wwv_flow_imp.id(25904304311210030)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25906234793210031)
,p_plugin_attribute_id=>wwv_flow_imp.id(25904304311210030)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25906610448210031)
,p_plugin_attribute_id=>wwv_flow_imp.id(25904304311210030)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25907080342210032)
,p_plugin_attribute_id=>wwv_flow_imp.id(25904304311210030)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25907489760210032)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25907781555210032)
,p_plugin_attribute_id=>wwv_flow_imp.id(25907489760210032)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25908124976210032)
,p_plugin_attribute_id=>wwv_flow_imp.id(25907489760210032)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25908580699210033)
,p_plugin_attribute_id=>wwv_flow_imp.id(25907489760210032)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25908972691210033)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25909282661210033)
,p_plugin_attribute_id=>wwv_flow_imp.id(25908972691210033)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25909660156210033)
,p_plugin_attribute_id=>wwv_flow_imp.id(25908972691210033)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25910059114210034)
,p_plugin_attribute_id=>wwv_flow_imp.id(25908972691210033)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25910431136210034)
,p_plugin_attribute_id=>wwv_flow_imp.id(25908972691210033)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25910892407210034)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25911197526210034)
,p_plugin_attribute_id=>wwv_flow_imp.id(25910892407210034)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25911586683210035)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25911896652210035)
,p_plugin_attribute_id=>wwv_flow_imp.id(25911586683210035)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25912250013210035)
,p_plugin_attribute_id=>wwv_flow_imp.id(25911586683210035)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25912604357210036)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1696237712328008202)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25912956887210036)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25913242858210036)
,p_plugin_attribute_id=>wwv_flow_imp.id(25912956887210036)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25913669111210036)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25913932928210036)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1834344221286103330)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1834345480806107478)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1537392706390344900)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1820750592611696597)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1821429893341779701)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1834342286219058344)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1834343619609072201)
,p_plugin_id=>wwv_flow_imp.id(25892578332210018)
