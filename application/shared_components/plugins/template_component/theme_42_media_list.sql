...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(25919284306210046)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1825937126286093697)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1825937681298093698)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25919991601210049)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25920296960210050)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25920539567210050)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25920884416210050)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25921117801210051)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(25920539567210050)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1825937681298093698)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25921499054210051)
,p_plugin_attribute_id=>wwv_flow_imp.id(25921117801210051)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25921895701210051)
,p_plugin_attribute_id=>wwv_flow_imp.id(25921117801210051)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25922282211210051)
,p_plugin_attribute_id=>wwv_flow_imp.id(25921117801210051)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25922657729210052)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(25921117801210051)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25922934971210052)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25923232060210052)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25923530363210052)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25923850891210053)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25924106178210053)
,p_plugin_attribute_id=>wwv_flow_imp.id(25923850891210053)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25924531509210053)
,p_plugin_attribute_id=>wwv_flow_imp.id(25923850891210053)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25924938227210054)
,p_plugin_attribute_id=>wwv_flow_imp.id(25923850891210053)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25925345659210054)
,p_plugin_attribute_id=>wwv_flow_imp.id(25923850891210053)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25925750421210054)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(25920884416210050)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1825937126286093697)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25926008019210054)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25926325723210055)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25926695854210055)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25926963089210055)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25927228691210055)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25927534952210056)
,p_plugin_attribute_id=>wwv_flow_imp.id(25927228691210055)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25927992561210056)
,p_plugin_attribute_id=>wwv_flow_imp.id(25927228691210055)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25928315346210056)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25928666110210056)
,p_plugin_attribute_id=>wwv_flow_imp.id(25928315346210056)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25929074667210056)
,p_plugin_attribute_id=>wwv_flow_imp.id(25928315346210056)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25929419798210057)
,p_plugin_attribute_id=>wwv_flow_imp.id(25928315346210056)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25929822567210057)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25930107450210057)
,p_plugin_attribute_id=>wwv_flow_imp.id(25929822567210057)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25930558066210057)
,p_plugin_attribute_id=>wwv_flow_imp.id(25929822567210057)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25930927797210058)
,p_plugin_attribute_id=>wwv_flow_imp.id(25929822567210057)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25931350846210058)
,p_plugin_attribute_id=>wwv_flow_imp.id(25929822567210057)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25931780019210058)
,p_plugin_attribute_id=>wwv_flow_imp.id(25929822567210057)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25932150335210058)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25932464749210059)
,p_plugin_attribute_id=>wwv_flow_imp.id(25932150335210058)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25932851217210059)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1826140733455240326)
,p_plugin_id=>wwv_flow_imp.id(25919284306210046)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
