...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(72076841667750711)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1872094683647634362)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1872095238659634363)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72077548962750714)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72077854321750715)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72078096928750715)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72078441777750715)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72078675162750716)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(72078096928750715)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1872095238659634363)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72079056415750716)
,p_plugin_attribute_id=>wwv_flow_imp.id(72078675162750716)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72079453062750716)
,p_plugin_attribute_id=>wwv_flow_imp.id(72078675162750716)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72079839572750716)
,p_plugin_attribute_id=>wwv_flow_imp.id(72078675162750716)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72080215090750717)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(72078675162750716)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72080492332750717)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72080789421750717)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72081087724750717)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72081408252750718)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72081663539750718)
,p_plugin_attribute_id=>wwv_flow_imp.id(72081408252750718)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72082088870750718)
,p_plugin_attribute_id=>wwv_flow_imp.id(72081408252750718)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72082495588750719)
,p_plugin_attribute_id=>wwv_flow_imp.id(72081408252750718)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72082903020750719)
,p_plugin_attribute_id=>wwv_flow_imp.id(72081408252750718)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72083307782750719)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(72078441777750715)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1872094683647634362)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72083565380750719)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72083883084750720)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72084253215750720)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72084520450750720)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72084786052750720)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72085092313750721)
,p_plugin_attribute_id=>wwv_flow_imp.id(72084786052750720)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72085549922750721)
,p_plugin_attribute_id=>wwv_flow_imp.id(72084786052750720)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72085872707750721)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72086223471750721)
,p_plugin_attribute_id=>wwv_flow_imp.id(72085872707750721)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72086632028750721)
,p_plugin_attribute_id=>wwv_flow_imp.id(72085872707750721)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72086977159750722)
,p_plugin_attribute_id=>wwv_flow_imp.id(72085872707750721)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72087379928750722)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72087664811750722)
,p_plugin_attribute_id=>wwv_flow_imp.id(72087379928750722)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72088115427750722)
,p_plugin_attribute_id=>wwv_flow_imp.id(72087379928750722)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72088485158750723)
,p_plugin_attribute_id=>wwv_flow_imp.id(72087379928750722)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72088908207750723)
,p_plugin_attribute_id=>wwv_flow_imp.id(72087379928750722)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72089337380750723)
,p_plugin_attribute_id=>wwv_flow_imp.id(72087379928750722)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72089707696750723)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72090022110750724)
,p_plugin_attribute_id=>wwv_flow_imp.id(72089707696750723)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72090408578750724)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1872298290816780991)
,p_plugin_id=>wwv_flow_imp.id(72076841667750711)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
