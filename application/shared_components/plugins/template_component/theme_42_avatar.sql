...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(72021884613750640)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72022182668750645)
,p_plugin_id=>wwv_flow_imp.id(72021884613750640)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72022499842750645)
,p_plugin_attribute_id=>wwv_flow_imp.id(72022182668750645)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72022915104750646)
,p_plugin_attribute_id=>wwv_flow_imp.id(72022182668750645)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72023274835750646)
,p_plugin_attribute_id=>wwv_flow_imp.id(72022182668750645)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72023754217750647)
,p_plugin_id=>wwv_flow_imp.id(72021884613750640)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(72022182668750645)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72024016169750647)
,p_plugin_id=>wwv_flow_imp.id(72021884613750640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72024272328750647)
,p_plugin_id=>wwv_flow_imp.id(72021884613750640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72024563978750648)
,p_plugin_id=>wwv_flow_imp.id(72021884613750640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72024916194750648)
,p_plugin_id=>wwv_flow_imp.id(72021884613750640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72025225160750648)
,p_plugin_attribute_id=>wwv_flow_imp.id(72024916194750648)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72025561242750648)
,p_plugin_attribute_id=>wwv_flow_imp.id(72024916194750648)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72025991879750649)
,p_plugin_attribute_id=>wwv_flow_imp.id(72024916194750648)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72026363008750649)
,p_plugin_attribute_id=>wwv_flow_imp.id(72024916194750648)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72026803538750649)
,p_plugin_id=>wwv_flow_imp.id(72021884613750640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72027069614750650)
,p_plugin_attribute_id=>wwv_flow_imp.id(72026803538750649)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72027463305750650)
,p_plugin_attribute_id=>wwv_flow_imp.id(72026803538750649)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72027877830750650)
,p_plugin_attribute_id=>wwv_flow_imp.id(72026803538750649)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72028257759750650)
,p_plugin_attribute_id=>wwv_flow_imp.id(72026803538750649)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72028674941750651)
,p_plugin_attribute_id=>wwv_flow_imp.id(72026803538750649)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72029122840750651)
,p_plugin_attribute_id=>wwv_flow_imp.id(72026803538750649)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(72029477236750651)
,p_plugin_attribute_id=>wwv_flow_imp.id(72026803538750649)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(72029923222750652)
,p_plugin_id=>wwv_flow_imp.id(72021884613750640)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1872072798590864394)
,p_plugin_id=>wwv_flow_imp.id(72021884613750640)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
