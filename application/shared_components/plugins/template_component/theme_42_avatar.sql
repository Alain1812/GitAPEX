...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(25864327252209975)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25864625307209980)
,p_plugin_id=>wwv_flow_imp.id(25864327252209975)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25864942481209980)
,p_plugin_attribute_id=>wwv_flow_imp.id(25864625307209980)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25865357743209981)
,p_plugin_attribute_id=>wwv_flow_imp.id(25864625307209980)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25865717474209981)
,p_plugin_attribute_id=>wwv_flow_imp.id(25864625307209980)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25866196856209982)
,p_plugin_id=>wwv_flow_imp.id(25864327252209975)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(25864625307209980)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25866458808209982)
,p_plugin_id=>wwv_flow_imp.id(25864327252209975)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25866714967209982)
,p_plugin_id=>wwv_flow_imp.id(25864327252209975)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25867006617209983)
,p_plugin_id=>wwv_flow_imp.id(25864327252209975)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25867358833209983)
,p_plugin_id=>wwv_flow_imp.id(25864327252209975)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25867667799209983)
,p_plugin_attribute_id=>wwv_flow_imp.id(25867358833209983)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25868003881209983)
,p_plugin_attribute_id=>wwv_flow_imp.id(25867358833209983)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25868434518209984)
,p_plugin_attribute_id=>wwv_flow_imp.id(25867358833209983)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25868805647209984)
,p_plugin_attribute_id=>wwv_flow_imp.id(25867358833209983)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25869246177209984)
,p_plugin_id=>wwv_flow_imp.id(25864327252209975)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25869512253209985)
,p_plugin_attribute_id=>wwv_flow_imp.id(25869246177209984)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25869905944209985)
,p_plugin_attribute_id=>wwv_flow_imp.id(25869246177209984)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25870320469209985)
,p_plugin_attribute_id=>wwv_flow_imp.id(25869246177209984)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25870700398209985)
,p_plugin_attribute_id=>wwv_flow_imp.id(25869246177209984)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25871117580209986)
,p_plugin_attribute_id=>wwv_flow_imp.id(25869246177209984)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25871565479209986)
,p_plugin_attribute_id=>wwv_flow_imp.id(25869246177209984)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25871919875209986)
,p_plugin_attribute_id=>wwv_flow_imp.id(25869246177209984)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25872365861209987)
,p_plugin_id=>wwv_flow_imp.id(25864327252209975)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1825915241229323729)
,p_plugin_id=>wwv_flow_imp.id(25864327252209975)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
