...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(25882284915210005)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1825767765144241722)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25882727357210007)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25883010963210007)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25883355097210008)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25883698567210008)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25883975669210008)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(25888521703210012)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1825767765144241722)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25884245376210008)
,p_plugin_attribute_id=>wwv_flow_imp.id(25883975669210008)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25884659895210009)
,p_plugin_attribute_id=>wwv_flow_imp.id(25883975669210008)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25885023232210009)
,p_plugin_attribute_id=>wwv_flow_imp.id(25883975669210008)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25885447430210009)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(25883975669210008)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25885776504210009)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25886045843210010)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25886375433210010)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25886612904210010)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25886969818210010)
,p_plugin_attribute_id=>wwv_flow_imp.id(25886612904210010)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25887365789210011)
,p_plugin_attribute_id=>wwv_flow_imp.id(25886612904210010)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25887778291210011)
,p_plugin_attribute_id=>wwv_flow_imp.id(25886612904210010)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25888126074210011)
,p_plugin_attribute_id=>wwv_flow_imp.id(25886612904210010)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25888521703210012)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25888828455210012)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25889167463210013)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25889452805210013)
,p_plugin_attribute_id=>wwv_flow_imp.id(25889167463210013)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(25889845114210013)
,p_plugin_attribute_id=>wwv_flow_imp.id(25889167463210013)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(25890287343210014)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1825900432577343225)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1825899841072335768)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1825955464742317647)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1826107682455188418)
,p_plugin_id=>wwv_flow_imp.id(25882284915210005)
