...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(35202496459730516)
,p_plug_name=>'PruebaGitB'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(35202572974730517)
,p_name=>'P401_PRUEBA_GIT_B'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(35202496459730516)
,p_prompt=>'Prueba Git B'
