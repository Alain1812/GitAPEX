...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(74915000947887304)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80790440385567891)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(75684835577879667)
,p_plug_name=>'DatosExpedicion'
,p_parent_plug_id=>wwv_flow_imp.id(80790440385567891)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80790459914567892)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(75687086022879690)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(80790459914567892)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(75687573676879695)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(80677417260982896)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(80790919743567896)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(74915083919887305)
,p_name=>'P4_ID_EXPEDICION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(74915000947887304)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75684862942879668)
,p_name=>'P4_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(75684835577879667)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75685156277879670)
,p_name=>'P4_ESTADO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(75684835577879667)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75685237954879671)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75685355054879672)
,p_name=>'P4_DIRECCION'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(75684835577879667)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75685461769879674)
,p_name=>'P4_TELEFONO'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(75684835577879667)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75685650960879675)
,p_name=>'P4_VIAJE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(75684835577879667)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75685729319879676)
,p_name=>'P4_CIUDAD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(75684835577879667)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(75685868979879678)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(75686008206879679)
,p_event_id=>wwv_flow_imp.id(75685868979879678)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(80792810234567915)
,p_name=>'Descargar'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(80677417260982896)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(81358506750271166)
,p_event_id=>wwv_flow_imp.id(80792810234567915)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(80677739049982899)
