...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(25986743166210125)
,p_plug_name=>unistr('P\00E1gina principal')
,p_icon_css_classes=>'fa-home'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(25755885172209939)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(26003704677852412)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(26003887921852413)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(26005346377852428)
,p_plug_name=>'Filtro'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26006765819852442)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(26005346377852428)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(31519532394243401)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(26003887921852413)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(30559928188249520)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(30562414837249545)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(26003887921852413)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26004009431852415)
,p_name=>'P1_USUARIO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(26003704677852412)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26004156694852416)
,p_name=>'P1_TELEFONO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(26003704677852412)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26004292481852417)
,p_name=>'P1_EMAIL'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(26003704677852412)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26005447387852429)
,p_name=>'P1_MATRICULA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(26005346377852428)
,p_prompt=>'Matricula'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26006452549852439)
,p_name=>'P1_VIAJES_ABIERTOS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(26003887921852413)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26006531467852440)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(26006961912852444)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(32961099074344201)
,p_name=>'Refresh'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(26003887921852413)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(32961182900344202)
,p_event_id=>wwv_flow_imp.id(32961099074344201)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(26003887921852413)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(32961238405344203)
,p_event_id=>wwv_flow_imp.id(32961099074344201)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(34516956576442202)
,p_name=>'Refresh2'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(26005346377852428)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(34517085693442203)
,p_event_id=>wwv_flow_imp.id(34516956576442202)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(26005346377852428)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(26006833378852443)
...
,p_process_when_button_id=>wwv_flow_imp.id(26006765819852442)
,p_internal_uid=>26006833378852443
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(26004315976852418)
