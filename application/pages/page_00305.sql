...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(31523047671243436)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(31524137266243447)
,p_button_sequence=>100
,p_button_plug_id=>wwv_flow_imp.id(31523047671243436)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(31524242318243448)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31523129546243437)
,p_name=>'P305_ID_VIAJE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(31523047671243436)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31523267371243438)
,p_name=>'P305_PAIS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(31523047671243436)
,p_prompt=>'Pais'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31523468794243440)
,p_name=>'P305_CIUDAD'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(31523047671243436)
,p_prompt=>'Ciudad'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31523586646243441)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31523684357243442)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31523745592243443)
,p_name=>'P305_NOMBRE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(31523047671243436)
,p_prompt=>'Nombre'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31523957131243445)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31524092728243446)
,p_name=>'P305_EMAIL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(31523047671243436)
,p_prompt=>'Email'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31958900275268516)
,p_name=>'P305_FECHA'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(31523047671243436)
,p_prompt=>'Fecha'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(31524308463243449)
,p_name=>unistr('A\00F1adirExpedicion')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(31524137266243447)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31524480180243450)
,p_event_id=>wwv_flow_imp.id(31524308463243449)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31780040439075308)
,p_event_id=>wwv_flow_imp.id(31524308463243449)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(31958794953268514)
,p_name=>'Cancelar'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(31524242318243448)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31958883735268515)
,p_event_id=>wwv_flow_imp.id(31958794953268514)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CLOSE'
