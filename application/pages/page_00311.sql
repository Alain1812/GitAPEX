...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(34518497582442217)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(34518998174442222)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(34518497582442217)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(34519014657442223)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(34518598422442218)
,p_name=>'P311_ID_INFORME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(34518497582442217)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(34518637014442219)
,p_name=>'P311_ESTADO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(34518497582442217)
,p_prompt=>'Estado'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(34518747991442220)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(34519192032442224)
,p_name=>'Editar'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(34518998174442222)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(34519276207442225)
,p_event_id=>wwv_flow_imp.id(34519192032442224)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(34519304076442226)
,p_event_id=>wwv_flow_imp.id(34519192032442224)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(34519402145442227)
,p_name=>'Cancelar'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(34519014657442223)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(34519562164442228)
,p_event_id=>wwv_flow_imp.id(34519402145442227)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CLOSE'
