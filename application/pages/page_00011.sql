...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(75688815884879707)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80790579118567893)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(75689196776879711)
,p_plug_name=>'DatosInforme'
,p_region_name=>'DatosInforme'
,p_parent_plug_id=>wwv_flow_imp.id(80790579118567893)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(75689346501879712)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(75689452812879713)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(75689346501879712)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(81340560813736356)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(75689346501879712)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75688890081879708)
,p_name=>'P11_ID_FORMULARIO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(75688815884879707)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(80792515321567912)
,p_name=>'Descargar'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(75689452812879713)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(80792613591567913)
,p_event_id=>wwv_flow_imp.id(80792515321567912)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(80791374291567901)
...
,p_process_when_button_id=>wwv_flow_imp.id(75689452812879713)
