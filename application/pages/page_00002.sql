...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(34517414427442207)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(29127060391535588)
,p_plug_name=>'Viajes'
,p_parent_plug_id=>wwv_flow_imp.id(34517414427442207)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(29127564353535588)
,p_region_id=>wwv_flow_imp.id(29127060391535588)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(28757125936346636)
,p_card_id=>wwv_flow_imp.id(29127564353535588)
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(31520870325243414)
,p_card_id=>wwv_flow_imp.id(29127564353535588)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(34517121347442204)
...
,p_filtered_region_id=>wwv_flow_imp.id(29127060391535588)
,p_attribute_01=>'N'
,p_attribute_06=>'N'
,p_attribute_09=>'N'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(34521279411442245)
,p_name=>'Descargar'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(34521312985442246)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(34521458236442247)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(34521561171442248)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(34521674580442249)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(30562076820249541)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(34517121347442204)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(34521194309442244)
...
,p_button_redirect_url=>'f?p=&APP_ID.:&APP_PAGE_ID.:&SESSION.:FLOW_XMLP_OUTPUT_R'||wwv_flow_imp.id(34521279411442245)||''
,p_grid_new_row=>'N'
,p_grid_new_column=>'Y'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(35201317666730505)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(29128009986535589)
,p_name=>'P2_ORDER_BY'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(34517121347442204)
,p_item_default=>'ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(34517237638442205)
,p_name=>'P2_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(34517121347442204)
,p_prompt=>'Buscar ...'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(34517364036442206)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(31522582363243431)
,p_name=>'Refresh'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(29127060391535588)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31522691571243432)
,p_event_id=>wwv_flow_imp.id(31522582363243431)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(29127060391535588)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(31522772866243433)
,p_name=>unistr('A\00F1adirViaje')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(30562076820249541)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31522873546243434)
,p_event_id=>wwv_flow_imp.id(31522772866243433)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>unistr('A\00F1adirViaje')
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31522949822243435)
,p_event_id=>wwv_flow_imp.id(31522772866243433)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(35202077613730512)
,p_event_id=>wwv_flow_imp.id(31522772866243433)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(34517121347442204)
);
