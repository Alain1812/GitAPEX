...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(79290028314732691)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80675418604982876)
,p_plug_name=>'Grid'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(75687733135879696)
,p_plug_name=>'ListaInformes'
,p_parent_plug_id=>wwv_flow_imp.id(80675418604982876)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(79119230072884872)
,p_region_id=>wwv_flow_imp.id(75687733135879696)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(80675890496982881)
,p_card_id=>wwv_flow_imp.id(79119230072884872)
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(79121702205884897)
,p_card_id=>wwv_flow_imp.id(79119230072884872)
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(80677239075982894)
,p_card_id=>wwv_flow_imp.id(79119230072884872)
,p_action_type=>'BUTTON'
,p_position=>'PRIMARY'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80675514980982877)
,p_plug_name=>'Faceted'
,p_parent_plug_id=>wwv_flow_imp.id(80675418604982876)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader js-removeLandmark:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(71946675685750613)
...
,p_filtered_region_id=>wwv_flow_imp.id(75687733135879696)
,p_attribute_01=>'N'
,p_attribute_06=>'N'
,p_attribute_09=>'N'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(80789380400567881)
,p_name=>'Descargar'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(80789510249567882)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(80789588225567883)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(80789666359567884)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(80789797649567885)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(80789865754567886)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(79120598937884886)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(80675514980982877)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(80790053619567887)
...
,p_button_redirect_url=>'f?p=&APP_ID.:&APP_PAGE_ID.:&SESSION.:FLOW_XMLP_OUTPUT_R'||wwv_flow_imp.id(80789380400567881)||''
,p_grid_new_row=>'N'
,p_grid_new_column=>'Y'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(81340338127735696)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75688307335879702)
,p_name=>'P10_ID_EXPEDICION'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(75687733135879696)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(80675594361982878)
,p_name=>'P10_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(80675514980982877)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(80772021101785759)
,p_name=>'P10_ORDER_BY'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(80675514980982877)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(80790149924567888)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(79120657943884887)
,p_name=>'Recargar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(80675418604982876)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(79120763503884888)
,p_event_id=>wwv_flow_imp.id(79120657943884887)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(80675418604982876)
);
