...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(31783979230075347)
,p_plug_name=>'Editar'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(31957981401268506)
,p_button_sequence=>100
,p_button_plug_id=>wwv_flow_imp.id(31783979230075347)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(31958036627268507)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31784029987075348)
,p_name=>'P307_ID_EXPEDICION'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(31783979230075347)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31784173254075349)
,p_name=>'P307_PAIS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(31783979230075347)
,p_prompt=>'Pais'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31784294207075350)
,p_name=>'P307_CIUDAD'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(31783979230075347)
,p_prompt=>'Ciudad'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31957419232268501)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31957597942268502)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31957652522268503)
,p_name=>'P307_NOMBRE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(31783979230075347)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31957762255268504)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31957853288268505)
,p_name=>'P307_EMAIL'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(31783979230075347)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(31959005442268517)
,p_name=>'P307_FECHA'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(31783979230075347)
,p_prompt=>'Fecha'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(31958109887268508)
,p_name=>'Cancelar'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(31958036627268507)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31959424387268521)
,p_event_id=>wwv_flow_imp.id(31958109887268508)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31958215541268509)
,p_event_id=>wwv_flow_imp.id(31958109887268508)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(31958377471268510)
,p_name=>'EditarExpedicion'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(31957981401268506)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31959333745268520)
,p_event_id=>wwv_flow_imp.id(31958377471268510)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'Resetar'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31958510084268512)
,p_event_id=>wwv_flow_imp.id(31958377471268510)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31958441119268511)
,p_event_id=>wwv_flow_imp.id(31958377471268510)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(31959774564268524)
,p_name=>'CargarDatos2'
,p_event_sequence=>40
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31959958665268526)
,p_event_id=>wwv_flow_imp.id(31959774564268524)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_name=>'CargarDatos'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(31960119322268528)
,p_name=>'CargarDatos'
,p_event_sequence=>50
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31962111275268548)
,p_event_id=>wwv_flow_imp.id(31960119322268528)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31960352181268530)
,p_event_id=>wwv_flow_imp.id(31960119322268528)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31961802128268545)
,p_event_id=>wwv_flow_imp.id(31960119322268528)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
